...
namespace ButiEngine {
	...
	{
	public:
		Resource_Mesh_Dx12(std::shared_ptr<GraphicDevice> arg_graphicDevice);
		void Draw()override;
	...
	template<typename T>
	inline void ButiEngine::BackupData<T>::ResourceUpdate(std::shared_ptr<Resource_Mesh_Dx12> arg_resource,  std::weak_ptr<GraphicDevice_Dx12> arg_wkp_graphicDevice)
	{
		//頂点バッファの更新
